...
<h1>Tabela do livro de visitas</h1> 
	...
	<p>Nome: <strong><?php echo htmlspecialchars($linha["nome"], ENT_QUOTES, "UTF-8"); ?></strong></p>
   	<p>Localização: <strong><?php echo htmlspecialchars($linha["localizacao"], ENT_QUOTES, "UTF-8"); ?> | Postado em: <?php echo $dataFormatada; ?></strong></p>
	<p>Mensagem:</p>
    <p><strong><?php echo nl2br(htmlspecialchars($linha["mensagem"], ENT_QUOTES, "UTF-8")); ?> </strong></p><hr>
	<?php 
    } 

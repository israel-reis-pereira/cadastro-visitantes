...
<body>
   ...
   <!-- Comentários mantidos ocultos conforme o seu arquivo original -->
    ...
    <p><button onclick="window.location.href='conectar.php';">Conectar</button></p>
    <p><button onclick="window.location.href='resultados.php';">Resultados</button></p>
    <p><button onclick="window.location.href='resultados2.php';">Resultados2</button></p>
    --> 
